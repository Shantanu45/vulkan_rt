...
bool Rect2::is_equal_approx(const Rect2& p_rect) const {
	return math_helpers::is_equal_approx(position, p_rect.position) && math_helpers::is_equal_approx(size,p_rect.size);
}
...
bool Rect2::is_finite() const {
	return math_helpers::is_finite(position) && math_helpers::is_finite(size);
}
