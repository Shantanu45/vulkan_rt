...
void FrameTimer::enter_idle() { idle_start = get_time(); }
...
double FrameTimer::get_frame_time() const { return double(last_period) * 1e-9; }
...
double FrameTimer::get_elapsed() const { return double(last - start) * 1e-9; }

int64_t FrameTimer::get_time() { return get_current_time_nsecs(); }
...
int64_t get_current_time_usec() { return get_current_time_nsecs() / 1000; }

void Timer::start() { t = get_current_time_nsecs(); }
